...
//! @OsamaZerkawi only should this not  TourisemCard
class TourisemCard2 extends StatelessWidget {
  final TourismDto model;
  final bool isLoading;

  const TourisemCard2({super.key, required this.model, this.isLoading = false});
